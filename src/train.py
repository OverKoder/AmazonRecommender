...
def main():
    ...
    # Callback
    early_stopping = EarlyStopping('val_acc', mode = "max", patience = 1)


    # Trainer
    trainer = Trainer(accelerator='gpu', devices = 1, max_epochs=100, enable_progress_bar=True, callbacks = [early_stopping])
